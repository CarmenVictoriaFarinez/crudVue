            ...
            <table class="table">
                ...
                <tbody>
                    <tr v-for="paciente in pacientes" :key="paciente.id">
                        <td>{{ paciente.id }}</td>
                        <td>
                            <span v-if="formActualizar && idActualizar == paciente.id">
                        ...
                        <td>
                            ...
                            <span v-if="formActualizar && idActualizar == paciente.id">
                                <button @click="guardarActualizacion(paciente.id)" class="btn btn-success">Guardar</button>
                            </span>
                            <span v-else>
                                <!-- Botón para mostrar el formulario de actualizar -->
                                <button @click="verFormActualizar(paciente.id)" class="btn btn-warning">Actualizar</button>
                                <!-- Botón para borrar -->
                                <button @click="borrarPaciente(paciente_id)" class="btn btn-danger">Borrar</button>
                            </span>
                        </td>
                    </tr>
                </tbody>
